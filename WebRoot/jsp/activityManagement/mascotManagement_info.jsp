...
<body>
<form action="saveMascotManagement.html" name="mascotManagementForm" id="mascotManagementForm" target="result" method="post" onsubmit="return checkInfo();"  enctype="multipart/form-data">
    <input type="hidden" name="id" id="id" value="${mascotManagement.id}"/>
    <input type="hidden" name="content" id="content"/>
    <table border="0" cellpadding="0" cellspacing="0">
        <tr class="info">
            <th><span class="star" style="color:#f82e2a">*</span>标题:</th>
            <td><input type="text" name="name" id="name" class="input_txt" value="${mascotManagement.name}"/></td>
        </tr>

        <tr class="info">
            <th><span class="star" style="color:#f82e2a">*</span>内容:</th>
            <td><script id="editor" type="text/plain" style="width: 80%;height: 200px">${mascotManagement.content}</script></td>
        </tr>

        <tr class="info">
            <th><span class="star" style="color:#f82e2a">*</span>简介:</th>
            <td><input type="text" name="introduction" id="introduction" class="input_txt" value="${mascotManagement.introduction}"/></td>
        </tr>

        <tr class="info">
            <th><span class="star" style="color:#f82e2a">*</span>发布时间:</th>
            <td><input type="text" name="reportDate" id="reportDate" value="<fmt:formatDate value="${mascotManagement.reportDate}" pattern="yyyy-MM-dd"/>" onclick="WdatePicker()" readonly="readonly" style="width:70px;"/></td>
        </tr>

        <tr class="info">
            <th><span class="star" style="color:#f82e2a">*</span>排序:</th>
            <td><input type="text" name="sorting" id="sorting" class="input_txt" value="${mascotManagement.sorting}"/></td>
        </tr>

        <c:if test="${mascotManagement.id!=null}">
            <tr class="info">
                <th>原图:</th>
                <td><img src="${mascotManagement.fileURL}" style="width: 100px;height: 100px"></td>
            </tr>
        </c:if>
