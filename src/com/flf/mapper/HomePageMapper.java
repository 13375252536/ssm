 ...
 * @Description: //TODO  首页的mapper映射文件
 * @Author: Mr.Chan
...
public interface HomePageMapper {
     ...
     * @return
     * @Author Mr.Chan
     * @Description //TODO 通过QrCodeManagement实体类对象  修改二维码的url地址
     ...
     * @Author Mr.Chan
     * @Description //TODO 通过字符串"微博" 查询URL地址
     ...
     * @return java.lang.String
     * @Author Mr.Chan
     * @Description //TODO  通过字符串"微信" 查询url地址
     ...
     * @Author Mr.Chan
     * @Description //TODO  查询遍历出图片管理表
     * @Date 2018/8/29 12:54
     ...
     * @Author Mr.Chan
     * @Description //TODO  通过id查询图片管理的信息
...
//_________________123________________
