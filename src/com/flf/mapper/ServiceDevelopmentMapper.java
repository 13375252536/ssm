...
/**
 * @ClassName: ServiceDevelopmentMapper
 * @Description: //TODO
 * @Author: Mr.Chan
 * @Data: 2018/9/23 19:37
 * @Version: 1.0
 */
public interface ServiceDevelopmentMapper {
    /**
     * @Author Mr.Chan
   ...
   void updateGuideManagement(GuideManagement guideManagement);
    ...
    /**
     * @Author Mr.Chan
     * @Description //TODO   遍历查询政府性基金和行政事业型收费查询信息
    ...
    /**
     * @Author Mr.Chan
     * @Description //TODO   删除查询政府性基金和行政事业型收费查询信息
     * @Date 2018/9/25 11:13
     * @Param [chk_value]
     * @return void
     */
    ...
    /**
     * @Author Mr.Chan
     * @Description //TODO  查询政府性基金和行政事业型收费查询信息撤回发布
    ...
    /**
     * @Author Mr.Chan
     * @Description //TODO   修改查询政府性基金和行政事业型收费查询信息
     * @Date 2018/9/25 11:14
     * @Param [fundFeeEnquiry]
     * @return void
     */
    ...
    /**
     * @Author Mr.Chan
     * @Description //TODO   添加查询政府性基金和行政事业型收费查询信息
     * @Date 2018/9/25 11:14
     * @Param [fundFeeEnquiry]
     * @return void
     */
    ...
    /**
     * @Author Mr.Chan
     * @Description //TODO   通过id查询查询政府性基金和行政事业型收费查询信息
     * @Date 2018/9/25 11:14
     * @Param [id]
